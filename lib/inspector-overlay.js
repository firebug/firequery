...
/** @lends InspectorOverlay */
{
  ...
  renderNode: function(node, type, data) {
    ...
    Trace.sysout("InspectorOverlay.renderNode; " + this.markupScriptReady,
      jQueryData);
  ...
  onDataModified: function(nodeData, jQueryData) {
    ...
    // xxxHonza: insert or remove the little envelop into the
    // Inspector panel that indicates presence of jQuery data.
